...
public class ExpandingListView extends ListView {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            final Object listObject = getItemAtPosition(getPositionForView
                    (view));
            if (listObject instanceof ExpandableListItem) {
                ExpandableListItem viewObject = (ExpandableListItem) listObject;
    ...
    private void expandView(final View view) {
        expandView(view, getPositionForView
                (view));
    }

    private void expandView(final View view, final int position) {
        final ExpandableListItem viewObject = (ExpandableListItem) getItemAtPosition(position);
            ...
            public boolean onPreDraw() {
                ...
                if (!mShouldRemoveObserver) {
                    ...
                    * by the ListView.*/
                    ...
                    int firstVisibleTop = getChildAt(getFirstVisiblePosition()).getTop();
                    ...
                    scrollTo(0,firstVisibleTop+firstChildStartTop-deltaTop);
//                    setSelection(firstVisiblePosition);
//                    scrollListBy(firstChildStartTop-deltaTop);
//                    scrollBy(0, firstChildStartTop - deltaTop);
...
//                    return false;
    ...
    private void collapseView(final View view) {
        collapseView(view, getPositionForView(view));
    }

    private void collapseView(final View view, int position) {
        final Object obj = getItemAtPosition(position);
        final ExpandableListItem viewObject = (ExpandableListItem) obj;
            ...
            public boolean onPreDraw() {
                ...
                if (!mShouldRemoveObserver) {
                    ...
                    * and added to it.*/
                    ...
                    int firstChildStartTop = getChildAt(0).getTop();
                    int firstVisiblePosition = getFirstVisiblePosition();
                    int firstVisibleTop = getChildAt(firstVisiblePosition).getTop();
                    int deltaTop = currentTop - futureTop;
